    ...
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="space-y-2 text-sm">
            ...
            <div class="flex text-base">
                ...
                <a href="tel:555-123-4567" aria-label="Our phone" title="Our phone"
                    class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">555-123-4567</a>
            </div>
            <div class="flex text-base">
