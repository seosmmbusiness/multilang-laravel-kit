...
@section('seo_header')
    <title>{{ __('seo.titleTerms') }}</title>
    <meta name="description" content="{{ __('seo.descriptionTerms') }}">
    <meta name="og:title" property="og:title" content="{{ __('seo.og:titleTerms') }}">
    <meta name="og:description" property="og:description" content="{{ __('seo.og:descriptionTerms') }}" />
    <meta name="twitter:title" content="{{ __('seo.titleTerms') }}">
    <meta name="twitter:description" content="{{ __('seo.descriptionTerms') }}">
@endsection
...
@section('content')
    ...
    <section id='TermsAndConditions'>
        <div class='max-w-screen-xl mx-auto'>
            <div class="bg-white px-5 py-5 text-justify text-gray-700">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Laravel 8 + Tailwind + Alpine JS
                            Multilanguage Landing Page Starter Kit.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Laravel 8 + Tailwind + Alpine JS Multilanguage Landing Page
                            Starter Kit, accessible from <a href="https://github.com/seosmmbusiness/multilang-laravel-kit"
                                rel="external nofollow noopener"
                                target="_blank">https://github.com/seosmmbusiness/multilang-laravel-kit</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: seosmmbusiness@gmail.com</li>
                </ul>
            </div>
        </div>
    </section>
