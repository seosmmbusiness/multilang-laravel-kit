...
return [
    ...
    */
    ...
    "og:site_name"=> "Plantilla de sitio web de ejemplo de Laravel 8 Multilang Seo",
    "og:description"=> "OG - Laravel 8 Multilang Seo Example - Plantilla para hacer un sitio web simple multilang"
];
